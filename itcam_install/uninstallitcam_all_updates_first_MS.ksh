...
updateDb=true
updateVe=true
uninstall.updates=7.1.0.2.7,7.1.0.2
#uninstall.updates=all
...
./silentUpdate.sh -prepareUninstall /tmp/silentUpdate.properties
...
cd /backup/portal/itcam/7.1.0.2-TIV-ITCAMAD_MS-IF0007
./silentUpdate.sh -uninstall /tmp/silentUpdate.properties
